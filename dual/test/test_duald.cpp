...
class DualdTest : public ::testing::Test
{
protected:
    ...
    static constexpr auto rel_tolerance = 1e-5;
    static constexpr auto abs_tolerance = 1e-8;

    static const value_type PI;
};

const DualdTest::value_type DualdTest::PI = std::acos(-value_type(1.0));

TEST_F(DualdTest, AdditionAssignment)
{
    auto d = Dual(value_type(1.0), value_type(2.0));
    d += Dual(value_type(3.0), value_type(4.0));
    EXPECT_DOUBLE_EQ(value_type(4.0), d.real());
    EXPECT_DOUBLE_EQ(value_type(6.0), d.dual());
}

TEST_F(DualdTest, SubtractionAssignment)
{
    auto d = Dual(value_type(1.0), value_type(2.0));
    d -= Dual(value_type(3.0), value_type(4.0));
    EXPECT_DOUBLE_EQ(-value_type(2.0), d.real());
    EXPECT_DOUBLE_EQ(-value_type(2.0), d.dual());
}

TEST_F(DualdTest, MultiplicationAssignment)
{
    {
        auto d = Dual(value_type(1.0), value_type(2.0));
        d *= Dual(value_type(3.0), value_type(4.0));
        EXPECT_DOUBLE_EQ(value_type(3.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(10.0), d.dual());
    }
    {
        auto d = Dual(value_type(1.0), value_type(2.0));
        d *= value_type(3.0);
...
TEST_F(DualdTest, DivisionAssignment)
{
    {
        auto d = Dual(value_type(1.0), value_type(2.0));
        d /= Dual(value_type(3.0), value_type(4.0));
        EXPECT_DOUBLE_EQ(value_type(1.0) / value_type(3.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(2.0) / value_type(9.0), d.dual());
    }
    {
        auto d = Dual(value_type(1.0), value_type(2.0));
    ...
    }
    {
        ...
        d /= value_type(3.0);
        EXPECT_DOUBLE_EQ(value_type(1.0) / value_type(3.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(2.0) / value_type(3.0), d.dual());
    }
    {
        auto d = Dual(value_type(-1.0), value_type(2.0));
        d /= value_type(0.0);
...
TEST_F(DualdTest, UnaryPlus)
{
    auto d = + Dual(value_type(1.0), value_type(2.0));
    EXPECT_DOUBLE_EQ(value_type(1.0), d.real());
    EXPECT_DOUBLE_EQ(value_type(2.0), d.dual());
}

TEST_F(DualdTest, UnaryMinus)
{
    auto d = - Dual(value_type(1.0), value_type(2.0));
    EXPECT_DOUBLE_EQ(-value_type(1.0), d.real());
    EXPECT_DOUBLE_EQ(-value_type(2.0), d.dual());
...
TEST_F(DualdTest, Multiplication)
{
    {
        auto d = Dual(value_type(1.0), value_type(2.0)) * Dual(value_type(3.0), value_type(4.0));
        EXPECT_DOUBLE_EQ(value_type(3.0), d.real());
...
TEST_F(DualdTest, abs)
{
    EXPECT_DOUBLE_EQ(value_type(0.0), dual::abs(Dual(value_type(0.0), value_type(0.0))));
    EXPECT_DOUBLE_EQ(value_type(3.0), dual::abs(Dual(value_type(3.0), value_type(0.0))));
    EXPECT_DOUBLE_EQ(value_type(0.0), dual::abs(Dual(value_type(0.0), value_type(4.0))));
    EXPECT_DOUBLE_EQ(value_type(3.0), dual::abs(Dual(value_type(3.0), value_type(4.0))));
    EXPECT_DOUBLE_EQ(value_type(3.0), dual::abs(Dual(-value_type(3.0), -value_type(0.0))));
    EXPECT_DOUBLE_EQ(value_type(0.0), dual::abs(Dual(-value_type(0.0), -value_type(4.0))));
    EXPECT_DOUBLE_EQ(value_type(3.0), dual::abs(Dual(-value_type(3.0), -value_type(4.0))));
}

TEST_F(DualdTest, norm)
{
    EXPECT_DOUBLE_EQ(value_type(0.0), dual::norm(Dual(value_type(0.0), value_type(0.0))));
    EXPECT_DOUBLE_EQ(value_type(9.0), dual::norm(Dual(value_type(3.0), value_type(0.0))));
    EXPECT_DOUBLE_EQ(value_type(0.0), dual::norm(Dual(value_type(0.0), value_type(4.0))));
    EXPECT_DOUBLE_EQ(value_type(9.0), dual::norm(Dual(value_type(3.0), value_type(4.0))));
    EXPECT_DOUBLE_EQ(value_type(9.0), dual::norm(Dual(-value_type(3.0), -value_type(0.0))));
    EXPECT_DOUBLE_EQ(value_type(0.0), dual::norm(Dual(-value_type(0.0), -value_type(4.0))));
    EXPECT_DOUBLE_EQ(value_type(9.0), dual::norm(Dual(-value_type(3.0), -value_type(4.0))));
}

TEST_F(DualdTest, conjugate)
{
    auto d = dual::conjugate(Dual(value_type(0.0), value_type(0.0)));
    EXPECT_DOUBLE_EQ(value_type(0.0), d.real());
    EXPECT_DOUBLE_EQ(value_type(0.0), d.dual());
...
TEST_F(DualdTest, normalize)
{
    auto src = Dual(value_type(3.0), value_type(4.0));
    auto dst = dual::abs(src) * dual::normalize(src);
    EXPECT_DOUBLE_EQ(src.real(), dst.real());
    EXPECT_DOUBLE_EQ(src.dual(), dst.dual());
}

TEST_F(DualdTest, sin)
{
    // theta = -pi
    {
...
TEST_F(DualdTest, exp)
{
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(std::exp(value_type(1.0)), d.real());
        EXPECT_DOUBLE_EQ(value_type(0.0), d.dual());
    }
    {
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(e, d.real());
        EXPECT_DOUBLE_EQ(value_type(2.0) * e, d.dual());
    }
}

TEST_F(DualdTest, log)
{
    {
...
TEST_F(DualdTest, log2)
{
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(value_type(0.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(2.0) / std::log(value_type(2.0)), d.dual());
    }
}

TEST_F(DualdTest, log10)
{
    {
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(value_type(0.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(2.0) / std::log(value_type(10.0)), d.dual());
    }
}

TEST_F(DualdTest, pow)
{
    {
...
TEST_F(DualdTest, square)
{
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(value_type(1.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(4.0), d.dual());
    }
}

TEST_F(DualdTest, sqrt)
{
    {
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(value_type(1.0), d.real());
        EXPECT_DOUBLE_EQ(value_type(1.0), d.dual());
    }
}

TEST_F(DualdTest, cube)
{
    {
...
TEST_F(DualdTest, cbrt)
{
    ...
    }
    {
        ...
        EXPECT_DOUBLE_EQ(expected, d.dual());
    }
}
